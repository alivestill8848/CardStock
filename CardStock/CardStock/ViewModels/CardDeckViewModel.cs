...
namespace Jarloo.CardStock.ViewModels
{
    public class CardDeckViewModel : DependencyObject
    {
        ...
        public CardDeckViewModel()
        {
            ...
            Console.Write(Quotes[0].LastTradePrice);
        }
    }
}